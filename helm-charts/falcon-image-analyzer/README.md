...
| `crowdstrikeConfig.enableAPIGateway`     optional                                                                          | use the api gateway. set to `true` if needed to use the api.crowdstrike.com for scans                                                                          | `false`                                                                                                     |
...
IAR requires internet access to your assigned CrowdStrike authenication API and upload servers.
...
In case of any issues with the above servers or if you need to use the old servers set the value 
`crowdstrikeConfig.enableAPIGateway` to `true` helm values and redeploy iar
